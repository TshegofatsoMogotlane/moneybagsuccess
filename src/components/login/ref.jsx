...
const Login = () => {
  ...
  const handleFacebookLogin = (e) => {
    e.preventDefault()
    // Redirect or integrate Facebook login here
    window.location.href = 'https://www.facebook.com/v10.0/dialog/oauth?client_id=YOUR_FACEBOOK_APP_ID&redirect_uri=YOUR_REDIRECT_URI';
  };

  const handleInstagramLogin = () => {
    // Redirect or integrate Instagram login here
    window.location.href = 'www.linkedin.com/in/idodata';
  };
  ...
  return (
    <div className="login-form">
      ...
      <form onSubmit={submitForm}>
        <button type="button" className="facebook-login" onClick={handleFacebookLogin}>Connect with Facebook</button>
        <button type="button" className="google-login" onClick={handleInstagramLogin}>Connect with Instagram</button>
